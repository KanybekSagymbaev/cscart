<?php /* Smarty version Smarty-3.1.21, created on 2022-04-21 08:38:23
         compiled from "W:\domains\ncode.kc\design\backend\templates\common\mainbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5745873606260edcfda7031-80001190%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b52c925f672afaf79ef38ba2adad7a6911ff51ff' => 
    array (
      0 => 'W:\\domains\\ncode.kc\\design\\backend\\templates\\common\\mainbox.tpl',
      1 => 1643359714,
      2 => 'tygh',
  ...
  'nocache_hash' => '5745873606260edcfda7031-80001190',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6260edd0043b99_16772479',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6260edd0043b99_16772479')) {function content_6260edd0043b99_16772479($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include 'W:/domains/ncode.kc/app/functions/smarty_plugins\\block.inline_script.php';
if (!is_callable('smarty_block_hook')) include 'W:/domains/ncode.kc/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_block_notes')) include 'W:/domains/ncode.kc/app/functions/smarty_plugins\\block.notes.php';
...
if (!is_callable('smarty_modifier_sanitize_html')) include 'W:/domains/ncode.kc/app/functions/smarty_plugins\\modifier.sanitize_html.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('notes','search','all_vendors','choose_action','sidebar','language','sidebar'));
?>
...
<?php $_tmp13=ob_get_clean();?><?php if (fn_check_view_permissions($_smarty_tpl->tpl_vars['m']->value['href'],$_tmp13)) {?>
...
} else { ?>btn-bar btn-toolbar<?php }?> nav__actions-bar dropleft pull-right" <?php if ($_smarty_tpl->tpl_vars['content_id']->value) {?>id="tools_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['content_id']->value, ENT_QUOTES, 'UTF-8');?>
_buttons"<?php }?>>
