<?php /* Smarty version Smarty-3.1.21, created on 2022-04-22 07:14:54
         compiled from "W:\domains\ncode.kc\design\backend\templates\views\block_manager\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139904995762622bbe75bf01-43288463%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ce63a2831ac60c74049373cd7fc3e64b65cfd3c3' => 
    array (
      0 => 'W:\\domains\\ncode.kc\\design\\backend\\templates\\views\\block_manager\\manage.tpl',
      1 => 1643359714,
      2 => 'tygh',
  ...
  'nocache_hash' => '139904995762622bbe75bf01-43288463',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62622bbe89efb2_88979976',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62622bbe89efb2_88979976')) {function content_62622bbe89efb2_88979976($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'W:/domains/ncode.kc/app/functions/smarty_plugins\\function.script.php';
...
if (!is_callable('smarty_function_render_location')) include 'W:/domains/ncode.kc/app/functions/smarty_plugins\\function.render_location.php';
?><?php
...
: <span class="wrap-word"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['name'], ENT_QUOTES, 'UTF-8');?>
        ...
        <div class="sidebar-field text-right">
            <a class="cm-dialog-opener right" href="<?php echo htmlspecialchars(fn_url("block_manager.update_location?location=".((string)$_smarty_tpl->tpl_vars['location']->value['location_id'])."&s_layout=".((string)$_smarty_tpl->tpl_vars['location']->value['layout_id'])), ENT_QUOTES, 'UTF-8');?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['name'], ENT_QUOTES, 'UTF-8');?>
"><?php echo $_smarty_tpl->__("layout_meta_data");?>
</a>
        </div>
    </div>
    <hr>
